    ...
    <div className="obs-universe-constellations">
      <ObservatoryEmergence minHeight="min-h-[55vh] sm:min-h-[70vh]" delay={0.1}>
        <div className="flex flex-col items-center text-center">
          <span className="obs-fx__plaque">Emerging patterns</span>
          <p className="obs-universe-whisper mx-auto mt-6 max-w-md">
            Read from the instruments on the wall. As observations gather, they
            arrange themselves around a question — you may notice the shape
            before it is named.
          </p>
        </div>
...
function ConstellationCluster({
  ...
  return (
    ...
    >
      <div className="obs-fx obs-fx--plate obs-pattern-plate">
        <div className="obs-fx__plaque obs-pattern-plate__plaque">
          {constellation.label}
        </div>
        <p className="obs-pattern-plate__legend">{constellation.whisper}</p>

        <div className="obs-fx__well obs-pattern-plate__well">
